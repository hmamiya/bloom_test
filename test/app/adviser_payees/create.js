...
xdescribe('bloomの入力テスト', () => {
    ...
    describe('顧問支払先登録_正常系', () => {
        ...
        it('値を入力して送信', () => {
            ...
            //支払先登録画面に遷移
            browser.click('//button[text()="支払先登録"]')
            browser.waitUntil(() => {
                return browser.getUrl() === 'http://54.95.18.112:8084/adviser_payee/' + id + '/create'
                }, 5000, 'expected text to be different after 5s');
            ...
            browser.setValue(agreement_document.selecter, agreement_document.value);
