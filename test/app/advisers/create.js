...
describe('adviser/create', () => {
    ...
    describe('顧問登録_正常系', () => {
        ...
        it('顧問名が表示されること', () => {
            var adviser_name_confirm = browser.getText('//tbody/tr[1]/td[2]');
            expect(adviser_name_confirm).toEqual(adviser_name.value);
        })
        it('電話番号が表示されること', () => {
            var tel_confirm = browser.getText('//tbody/tr[1]/td[3]');
            expect(tel_confirm).toEqual(tel.value);
        })
        it('メールアドレスが表示されること', () => {
            var mail_confirm = browser.getText('//tbody/tr[1]/td[4]');
            expect(mail_confirm).toEqual(mail.value);
        })
        it('住所が表示されること', () => {
            var address_confirm = browser.getText('//tbody/tr[1]/td[5]');
            expect(address_confirm).toEqual("東京都千代田区丸の内新丸の内ビルディング");
        })
        it('業務報告書回収担当が表示されること', () => {
            var report_collection_responsible_confirm = browser.getText('//tbody/tr[1]/td[6]');
