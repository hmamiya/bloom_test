...
describe('client_billings/create', () => {
    ...
    describe('企業請求先登録_正常系', () => {
        ...
        it('値を入力して送信', () => {
            ...
            //請求先登録画面に遷移
            browser.click('//button[text()="請求先登録"]')
            browser.waitUntil(() => {
                return browser.getUrl() === 'http://54.95.18.112:8084/client_billing/' + id + '/create'
                }, 5000, 'expected text to be different after 5s');
        ...
        it('町名・番地・建物等が表示されること', () => {
            ...
            expect(address2_confirm).toEqual(address2.value);
        });
    })
});